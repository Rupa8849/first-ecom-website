        ...
        <section class="h-screen w-screen" >
            ...
            <div id="profile-form" class="hidden flex items-center flex-1 h-full justify-center px-4 sm:px-0 sm:h-screen sm:w-screen">
                <div class="lg:flex rounded-lg shadow-xl  lg:pt-0 sm:w-[90%] lg:h-fit
                     lg:w-[50%] sm:h-screen sm:text-5xl sm:text-center sm:flex sm:items-center sm:justify-center hover:shadow-xl overflow-hidden">
                    <div class="flex-col sm:w-full sm:flex md:w-full p-4 sm:border-2 border-bronze bg-[url('images/blob-scene-haikei.png')] bg-cover rounded-lg">
                        ...
                        <div class="space-y-4 p-6">
                            <div class="flex w-full space-x-4">
                                <input type="text" name="fname" id="fname" class="w-1/2 rounded rounded" placeholder="*First name">
                                <input type="text" name="lname" id="lname" class="w-1/2 rounded rounded" placeholder="*Last name">
                            </div>
                            <div class="flex w-full space-x-4">
                                <input type="text" name="username" id="username" class="w-full rounded" placeholder="*Username">
                            </div>
                            <div class="flex w-full space-x-4">
                                <%      if(session.getAttribute("emailSession") != null) {
                                        String email = (String) session.getAttribute("emailSession");
                                %>
                                <input type="text" name="email" id="loademail" class="w-1/2 rounded" placeholder="*Email" 
                                       value=<%= email%>>
                                <%
                                } else {
                                %>
                                ...
                                %>
                                <!--<input type="text" name="mobile" id="loademail" class="disable w-1/2 rounded" placeholder="*Email ">-->
                                <input type="text" name="mobile" id="mobile" class="w-1/2 rounded" placeholder="*Mobile no ">
                            </div>
                            <div class="flex w-full space-x-4">
                                <input type="text" name="address" id="address" multiple="true" class="w-full rounded" placeholder="*Address">
                            </div>
                            <div class="flex w-full space-x-4">
                                <input type="text" name="state" id="state" class="w-1/2 rounded" placeholder="*State">
                                <input type="text" name="city" id="city" class="w-1/2 rounded" placeholder="*City">
                                <input type="text" name="pincode" id="pincode" class="w-1/2 rounded" placeholder="*Pincode">
                            </div>
                        </div>
                        <div class="w-full flex justify-center space-x-4">
                            ...
                            <button class="bg-black text-white uppercase
                                    lg:text-sm sm:text-4xl font-semibold lg:py-3 px-16 sm:py-8 rounded hover:bg-zinc-800">cancel
                            </button>
                        </div>
                    </div>
                </div>
